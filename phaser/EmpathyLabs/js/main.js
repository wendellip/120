...
joy1.prototype = 
{
	...
	create: function()
	{
		...
		this.switch1 = new onswitch(game, 'switches', 0, 48, 96, Math.PI, 'buttonSound');
		game.add.existing(this.switch1);
...
fear1.prototype = 
{
	...
	create: function()
	{
		...
		this.switch1 = new onswitch(game, 'switches', 0, 48, 128, Math.PI, 'buttonSound');
		game.add.existing(this.switch1);
...
fear2.prototype = 
{
	...
	create: function()
	{
		...
		this.switch1 = new onswitch(game, 'switches', 0, 80, 560, Math.PI / 2, 'buttonSound');
		game.add.existing(this.switch1);
...
sad1.prototype = 
{
	...
	create: function()
	{
		...
		this.switch1 = new onswitch(game, 'switches', 0, 48, 224, Math.PI, 'buttonSound');
		game.add.existing(this.switch1);
